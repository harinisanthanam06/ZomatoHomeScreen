...
import com.example.britesy.Model.Cart;
import com.example.britesy.Prevalent.Prevalent;
import com.example.britesy.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    private Button nextprocessbtn, nextprocess;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextprocess = (Button) findViewById(R.id.next_process);
        ...
        nextprocessbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txtTotalAmount.setText("Total Price = " + String.valueOf(overalltotal));

                Intent intent = new Intent(CartActivity.this, ConfirmArt.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter = new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder cartViewHolder, int i, @NonNull Cart cart) {
                cartViewHolder.textProductquantity.setText(cart.getQuantity());
                cartViewHolder.textProductPrice.setText(cart.getPrice());
                cartViewHolder.textProductName.setText(cart.getPname());

                int oneTypeProductPrice = Integer.valueOf(cart.getPrice()) * Integer.valueOf(cart.getQuantity());
                overalltotal = overalltotal + oneTypeProductPrice;
